        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => setFormData({ ...formData, payment_method: value, card_id: value === 'credit_card' ? formData.card_id : '' })}
            >
          ...
          {formData.payment_method === 'credit_card' && (
            <>
              <div>
                ...
                >
                  <SelectTrigger id="card_id" data-testid="transaction-card-select">
